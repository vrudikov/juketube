const app = angular.module('JukeTubeApp', []);
...
app.controller('VideosController', function ($scope, $http, $log, VideosService) {
    ...
    $scope.search = function () {
        $http.get('https://www.googleapis.com/youtube/v3/search', {
            params: {
                key: 'AIzaSyCv_Bmg5pcTuzxlWIqcFivZhMLyp4nGRPc',
                type: 'video',
                maxResults: '8',
                part: 'id,snippet',
            ...
            VideosService.listResults(youtubeResponse.data);
            $log.info(youtubeResponse.data);
        }).catch((e) => {
